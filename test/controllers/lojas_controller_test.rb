...
class LojasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create loja" do
    assert_difference('Loja.count') do
      post lojas_url, params: { loja: { cep: @loja.cep, cnpj: @loja.cnpj, estado: @loja.estado, fantasia: @loja.fantasia, razao_social: @loja.razao_social } }
    end
  ...
  test "should update loja" do
    patch loja_url(@loja), params: { loja: { cep: @loja.cep, cnpj: @loja.cnpj, estado: @loja.estado, fantasia: @loja.fantasia, razao_social: @loja.razao_social } }
