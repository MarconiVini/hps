...
class PlanosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plano" do
    assert_difference('Plano.count') do
      post planos_url, params: { plano: { ativo: @plano.ativo, descricao: @plano.descricao, valor: @plano.valor } }
    end
  ...
  test "should update plano" do
    patch plano_url(@plano), params: { plano: { ativo: @plano.ativo, descricao: @plano.descricao, valor: @plano.valor } }
