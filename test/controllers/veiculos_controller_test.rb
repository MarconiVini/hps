...
class VeiculosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post veiculos_url, params: { veiculo: { cor: @veiculo.cor, marca: @veiculo.marca, modelo: @veiculo.modelo, placa: @veiculo.placa, tipoveiculo_codtipoveiculo: @veiculo.tipoveiculo_codtipoveiculo } }
    end
  ...
  test "should update veiculo" do
    patch veiculo_url(@veiculo), params: { veiculo: { cor: @veiculo.cor, marca: @veiculo.marca, modelo: @veiculo.modelo, placa: @veiculo.placa, tipoveiculo_codtipoveiculo: @veiculo.tipoveiculo_codtipoveiculo } }
